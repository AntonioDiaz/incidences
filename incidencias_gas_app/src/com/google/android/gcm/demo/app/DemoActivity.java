...
public class DemoActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/* Make sure the manifest was properly set - comment out this line while developing the app, then uncomment it when it's ready. */
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		 ...
		 * Uncomment them if you want to manually register or unregister the device 
		 * (you will also need to uncomment the equivalent options on options_menu.xml). */
